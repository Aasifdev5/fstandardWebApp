...
@section('main_content')
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <a class="btn btn-pill btn-primary btn-air-primary pull-right"
                            href="{{ url('admin/mail-templates/add') }}" data-toggle="tooltip" title="" role="button"
                            ...
                            <table class="display" id="basic-1">
                                ...
                                <tbody>
                                    @foreach ($mailTemplates as $mailTemplate)
                                        <tr class="item">
                                            <td><input type="checkbox" class="template-checkbox"
                                                    value="{{ $mailTemplate->id }}"></td>
                                            <td>
    ...
    <script>
        ...
        document.getElementById('bulk-delete-btn').addEventListener('click', function() {
            const selectedIds = Array.from(document.querySelectorAll('.template-checkbox:checked')).map(checkbox =>
                checkbox.value);
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    axios.post('{{ url('admin/mail-templates/bulk-delete') }}', {
                        ...
                        Swal.fire('¡Error!', 'Hubo un problema al eliminar las plantillas.',
                            'error');
                    });
                }
            });
